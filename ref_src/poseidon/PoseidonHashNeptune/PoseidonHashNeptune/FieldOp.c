...
// Parameters for generating Round Constant and mds matrix use in lotus project
// Parameters from [https://github.com/filecoin-project/ff] and [https://github.com/porcuquine/poseidon]


//[TEARS] : MODULUS = 0x73eda753299d7d483339d80809a1d80553bda402fffe5bfeffffffff00000001!
//[TEARS] : GENERATOR = 0x351332208fc5a8c4ff9c57876f8457b017e363d300189c0f0000000efffffff1!
//[TEARS] : ROOT_OF_UNITY = 0x5bf3adda19e9b27b0af53ae352a31e645b1b4c801819d7ecb9b58d8c5f0e466a!
//[TEARS] : R2 = 0x0748d9d99f59ff1105d314967254398f2b6cedcb87925c23c999e990f3f29c6d!
//[TEARS] : R = 0x1824b159acc5056f998c4fefecbc4ff55884b7fa0003480200000001fffffffe!
//[TEARS] : INV = 18446744069414584319!
//[TEARS] : MODULUS_BITS = 255!
//[TEARS] : S = 32!
//[TEARS] : REPR_SHAVE_BITS = 1!

//
// Poseidon hash modulur M for lotus PC2:
// Decimal:     52435875175126190479447740508185965837690552500527637822603658699938581184513
// Hexadecimal: 0x73eda753299d7d483339d80809a1d80553bda402fffe5bfeffffffff00000001
// Fr:          0xffffffff00000001, 0x53bda402fffe5bfe, 0x3339d80809a1d805, 0x73eda753299d7d48

// This is the modulus m of the prime field
const Fr g_FrM = { 0xffffffff00000001, 0x53bda402fffe5bfe, 0x3339d80809a1d805, 0x73eda753299d7d48 };
// Multiplicative generator of `MODULUS` - 1 order, also quadratic nonresidue
const Fr g_FrG = { 0x0000000efffffff1, 0x17e363d300189c0f, 0xff9c57876f8457b0, 0x351332208fc5a8c4 };
// -(m^{-1} mod m) mod m
const Fr g_FrInv = { 0xfffffffeffffffff, 0, 0, 0 };
// 2^s root of unity computed by GENERATOR^t
const Fr g_FrRoU = { 0xb9b58d8c5f0e466a, 0x5b1b4c801819d7ec, 0x0af53ae352a31e64, 0x5bf3adda19e9b27b };
// 2^{limbs*64} mod m
const Fr g_FrR = { 0x00000001fffffffe, 0x5884b7fa00034802, 0x998c4fefecbc4ff5, 0x1824b159acc5056f };
// 2^{limbs*64*2} mod m   // R^2 % M
const Fr g_FrR2 = { 0xc999e990f3f29c6d, 0x2b6cedcb87925c23, 0x05d314967254398f, 0x0748d9d99f59ff11 };
// 2^s * t = MODULUS - 1 with t odd
const uint64_t g_S = 32;
